...
private:
	...
	/** Sound played when FItem is picked up */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	class USoundCue* PickupSound;

	/** Sound played whe Item is equipped */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
...
public:
	...
	FORCEINLINE void SetCanChangeCustomDepth(bool State) { bCanChangeCustomDepth = State; }
